...
let getHomepage = async function(req, res) {
  // Call the requireLogin middleware
  // requireLogin(req, res, () => {
  //   // Middleware passed, continue with the route handler logic
  // });
  res.render('index',{userData: req.session });
};
...
// }
module.exports = {
    getHomepage,getUserLogin,getUserSignup,
} 